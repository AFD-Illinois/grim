                           ...
                           REAL fluxX2Tile[ARRAY_ARGS TILE_SIZE])
{
  ...
  /* Requires NG=3 */
  LOOP_INSIDE_TILE(-2, TILE_SIZE_X2+2, -2, TILE_SIZE_X1+2)
  {
  ...
  /* Flux CT */
  REAL emf[TILE_SIZE];
  LOOP_INSIDE_TILE(0, TILE_SIZE_X2+2, 0, TILE_SIZE_X1+2)
  {
    struct gridZone zone;
    setGridZone(iTile, jTile,
                iInTile, jInTile,
  ...
  LOOP_INSIDE_TILE(0, TILE_SIZE_X2+1, 0, TILE_SIZE_X1+1)
  {
    struct gridZone zone;
    setGridZone(iTile, jTile,
                iInTile, jInTile,
    ...
    fluxX1Tile[INDEX_TILE(zone, B2)] = 0.5*(  emf[INDEX_TILE(zone, 0)]
